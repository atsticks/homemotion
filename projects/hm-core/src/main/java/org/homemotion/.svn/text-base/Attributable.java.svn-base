...
import org.homemotion.dao.spi.AttributeEntity;

public interface Attributable {

	public <T extends Serializable> boolean defineAttribute(String name, Class<T> type);

	public <T extends Serializable> boolean defineAttribute(String name, Class<T> type,
			T initialValue);

	public AttributeEntity removeAttribute(String name);

	public Class<?> getAttributeType(String name);

	public <T> T getAttribute(String name, Class<T> type);

	public AttributeEntity getAttribute(String name);
	...
	public <T extends Serializable> void setAttribute(String key, T value, Class<T> type,
			boolean triggerEvents);
